function SHA1(d){function l(a,b){return a<<b|a>>>32-b}function n(a){var b="",d,c;for(d=7;0<=d;d--)c=a>>>4*d&15,b+=c.toString(16);return b}var a,c,g=Array(80),p=1732584193,q=4023233417,r=2562383102,t=271733878,u=3285377520,b,e,f,h,k;d=function(a){a=a.replace(/\r\n/g,"\n");for(var b="",d=0;d<a.length;d++){var c=a.charCodeAt(d);128>c?b+=String.fromCharCode(c):(127<c&&2048>c?b+=String.fromCharCode(c>>6|192):(b+=String.fromCharCode(c>>12|224),b+=String.fromCharCode(c>>6&63|128)),b+=String.fromCharCode(c&
